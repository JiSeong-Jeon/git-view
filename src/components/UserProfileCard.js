...
const UserProfileCard = ({ userdata, repodata }) => {
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-md w-full max-w-3xl flex overflow-hidden">
        ...
        <div className="w-48 bg-gray-50 p-6 flex flex-col items-center border-r">
          ...
          <h2 className="text-sm font-medium text-gray-800">{userdata.name}</h2>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-6 mb-2">
              <div>
                ...
                <p className="text-sm text-gray-800">{userdata.public_repos}</p>
              </div>
              <div>
                <label className="block text-xs text-gray-500 mb-1">
                  Followers
                </label>
                <p className="text-sm text-gray-800">{userdata.followers}</p>
              </div>
              <div>
                <label className="block text-xs text-gray-500 mb-1">
                  Following
                </label>
                <p className="text-sm text-gray-800">{userdata.following}</p>
              </div>
            </div>
          </div>
          <div>
